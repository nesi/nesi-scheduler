...
/**
 * The persistent class for the inodes database table.
 * 
 */
@Entity
@Table(name="inodes")
@NamedQueries( {@NamedQuery(name="Inode.findAll", query="SELECT i FROM Inode i"),
	@NamedQuery(name="Inode.findByCode", query="SELECT i FROM Inode i where i.fileset like :projectCode")})
public class Inode implements Serializable {
	...
	public Inode(Date awarded, String awarder, Date expiry, String fileset, String note, int quota) {
		super();
